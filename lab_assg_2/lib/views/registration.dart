...
import 'package:lab_assg_2/views/loginScreen.dart';
...
class _registration extends State<registration> {
  ...
  String pathAsset = 'assets/images/profile_pic.png';
  var _image;
  ...
  void _addUser() {
    ...
    String fullName = fullNameEditingController.text;
    String address = addressEditingController.text;
    String phone= phoneEditingController.text;
    String email = emailEditingController.text;
    String password = _userpasswordEditingController.text;
    String base64Image = base64Encode(_image!.readAsBytesSync());
    
    http.post(
        Uri.parse(CONSTANTS.server + "/MYTutor/users/php/registration.php"),
        body: {
          "name": fullName,
          "address": address,
          "phone": phone,
